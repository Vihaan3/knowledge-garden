...
*Quirky bug: The note dates update every time I sync with my Obsidian notes (which is everyday), so the dates for every note will almost always be within the last few days.*
