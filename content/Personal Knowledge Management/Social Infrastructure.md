...
In an ideal world, the education system would [fill that role](https://vihaansondhi.substack.com/p/reforming-american-schools), but a well-designed system of school clubs can approximate for that in the absence of broader education reform. These clubs should be deliberately engineered to cultivate the general space of traits that encompass sparkliness. 
...
The only things I would add are thoughts on (1) "what do we do with the people" and (2) what the organization look like. 

1. I would like the default state to be weekly [Socratica](https://toolbox.socratica.info/)-style sessions on convenient nights or weekends. Every week, you dedicate time to learn/make/do something (unlike Socratica, I don't think the emphasis should *just* be on making), and with some clever social engineering you hopefully continue doing that outside of those sessions as well. There are consistently recurring special events like essay contests, speaker events, days booked out for participant-run workshops, hackathons, etc. 
