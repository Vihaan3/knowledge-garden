...
- **Use [[Meta-Learning#Using Spaced Repetition Systems|Anki]]** (Important to read this link to understand the rest)
	...
	- In those examples I only showed one card per "topic", but in general you want to add 3-5.
