...
- **Broad introduction**: This is a more generalized version of [[how to be a great blogger]]. Generating new ideas is mostly an exercise in [[Contrarian Thinking]] (which is itself mostly an exercise in [[First Principles]] thinking), because the idea wouldn't be important if it had already been executed, and obvious ideas have already been executed. If you want to develop contrarian ideas is a specific domain (advice taken from Paul Graham):
	- get to the frontiers of knowledge in that domain
		- Good [[Evergreen Notes]], memory systems, srs systems, use this: https://guzey.com/personal/what-should-you-do-with-your-life/#how-to-actually-work-on-the-problem-you-like (and the rest of the post is really good too!)
	- notice gaps in the knowledge
		- Spend more time doing personal notetaking (too many people believe that notetaking is something to do for other people's ideas). Talk to people
	- **Other misc things**:
